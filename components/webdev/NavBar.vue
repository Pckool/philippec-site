        ...
        <nav id="nav-bar" class="menu-bar container-fluid fixed-bottom">
            <div class="row menu-row1 justify-content-around">
                <div class="col-auto menu-item">
                    <nuxt-link id="nav-contact" :to="{name: 'webdev-contact'}" class="menu-link" >
						contact
					</nuxt-link>
                </div>
                <div class="col-auto menu-item">
                    <nuxt-link id="nav-skills" :to="{name: 'webdev-skills'}" class="menu-link">
						skills
					</nuxt-link>
                </div>
                <div class="col-auto menu-item ">
                    <nuxt-link id="nav-projects" :to="{name: 'webdev-projects'}" class="menu-link">
						projects
					</nuxt-link>
                </div>
                <div class="col-auto menu-item">
